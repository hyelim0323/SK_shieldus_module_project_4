...
class Solver(object):
    ...
    def test(self):
        ...
        face_emotion_list = ["Fear", "Happy", "Neutral", "Sad", "Surprise", "Angry"] 
        ...
        with torch.no_grad():
            for i, (x_real, c_org) in enumerate(data_loader):
                ...
                for c_trg in c_trg_list:
                    ...
                    print(c_trg.shape)
                    print(c_trg[:1, :])
                    x_fake_list = self.G(x_real[:1, :], c_trg[:1, :])
                    print(x_fake_list.shape)

                    # Save the translated images.
                    x_concat = x_fake_list
                    result_path = os.path.join(self.result_dir, f'{face_emotion_list[i-1]}.jpg')
